...
数据说明：ETF 历史日线已通过 iFinD HTTP 增量刷新至 `2026-07-08`。由于 `2026-07-08` 是周三，不是周五调仓日，因此最新推荐组合仍使用 `2026-07-03` 的周度信号。刷新过程中已对 ETF 拆分/复权口径导致的交易价格跳变做连续性修正，避免把技术性除权误计为真实回撤。
